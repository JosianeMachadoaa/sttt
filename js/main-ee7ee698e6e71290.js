        ...
        getMiddleware() {
          return (
            (window.__MIDDLEWARE_MATCHERS = [
              {
                regexp:
                  "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|static|_next|favicon.ico|robots.txt)(?!.*\\/[^\\/]*\\.[^\\/]{2,4}$).*))(.json)?[\\/#\\?]?$",
                originalSource:
    ...
    32997: function (r, n, o) {
      ...
      async function matchesMiddleware(r) {
        ...
        let { pathname: o } = (0, A.parsePath)(r.asPath),
          ...
          u = (0, M.addBasePath)((0, x.addLocale)(l, r.locale));
      ...
      function handleHardNavigation(r) {
        ...
        if (n === (0, M.addBasePath)((0, x.addLocale)(o.asPath, o.locale)))
          throw Error(
      ...
      let Router = class Router {
            ...
            for (let _ of [r, n])
              if (_) {
                let n = (0, s.removeTrailingSlash)(
                  ...
                  y = (0, M.addBasePath)((0, x.addLocale)(n, o || this.locale));
                if (
                  n !==
        ...
        async change(r, n, o, l, u) {
          ...
          if ((X && ef && (Y = !1), Y && "/_error" !== eo)) {
            if (((l._shouldResolveHref = !0), o.startsWith("/"))) {
              let r = (0, S.default)(
                (0, M.addBasePath)((0, x.addLocale)(er, $.locale), !0),
                G,
                V,
                ei,
          ...
          if (!(0, U.isLocalURL)(o))
            return handleHardNavigation({ url: o, router: this }), !1;
          (el = (0, C.removeLocale)((0, j.removeBasePath)(el), $.locale)),
          ...
          try {
            ...
            let g = l.shallow && $.route === (null != (L = s.route) ? L : eu),
            ...
            let A =
              X && !S && !Q && !en && (0, F.compareRouterStates)(w, this.state);
            if (!A) {
              try {
                await this.set(w, s, S);
              } catch (r) {
        ...
        async prefetch(r, n, o) {
          ...
          if (n.startsWith("/")) {
            ...
            let u = (0, S.default)(
              (0, M.addBasePath)((0, x.addLocale)(n, this.locale), !0),
              _,
              o,
              l.query,
